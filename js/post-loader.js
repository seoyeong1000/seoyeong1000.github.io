...
(function () {
  ...
  function loadGiscus() {
    ...
    script.setAttribute("data-repo-id", "YOUR_REPO_ID"); // Giscus 설정에서 가져온 값으로 변경 필요
    script.setAttribute("data-category", "General");
    script.setAttribute("data-category-id", "YOUR_CATEGORY_ID"); // Giscus 설정에서 가져온 값으로 변경 필요
